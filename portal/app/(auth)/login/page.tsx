...
export default function LoginPage() {
  ...
  // Display callback errors (e.g., failed OAuth)
  useEffect(() => {
  ...
  async function handleEmailLogin(e: React.FormEvent) {
    ...
    // PostHog: identify and track login (use data from signIn response directly)
    if (data.user) {
    ...
    <div className="auth-page">
      <div className="auth-window">
        <div className="hero-window">
          <div className="hero-title-bar">LOG IN</div>
          <div className="window-content">
            <div className="auth-header">
              <h1>Welcome Back</h1>
              <p>Log in to your Fractal Partners account</p>
            </div>
